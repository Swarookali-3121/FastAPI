...
def test_return_user(test_user):
    ...
    assert response.json()["username"] == "virat"
    assert response.json()["email"] == "virat@gmail.com"
    assert response.json()["first_name"] == "virat"
    assert response.json()["last_name"] == "kohli"
